...
import (
	...
	"github.com/UgnineSirdis/ydb-go-sdk/v3/internal/scheme/config"
...
func (c *Client) MakeDirectory(ctx context.Context, path string) (finalErr error) {
	onDone := trace.SchemeOnMakeDirectory(c.config.Trace(), &ctx,
		stack.FunctionID("github.com/UgnineSirdis/ydb-go-sdk/v3/internal/scheme.(*Client).MakeDirectory"),
		path,
	)
	defer func() {
		onDone(finalErr)
...
func (c *Client) RemoveDirectory(ctx context.Context, path string) (finalErr error) {
	onDone := trace.SchemeOnRemoveDirectory(c.config.Trace(), &ctx,
		stack.FunctionID("github.com/UgnineSirdis/ydb-go-sdk/v3/internal/scheme.(*Client).RemoveDirectory"),
		path,
	)
	defer func() {
		onDone(finalErr)
...
func (c *Client) ListDirectory(ctx context.Context, path string) (d scheme.Directory, finalErr error) {
	onDone := trace.SchemeOnListDirectory(c.config.Trace(), &ctx,
		stack.FunctionID("github.com/UgnineSirdis/ydb-go-sdk/v3/internal/scheme.(*Client).ListDirectory"),
	)
	defer func() {
		onDone(finalErr)
	}()
...
func (c *Client) DescribePath(ctx context.Context, path string) (e scheme.Entry, finalErr error) {
	onDone := trace.SchemeOnDescribePath(c.config.Trace(), &ctx,
		stack.FunctionID("github.com/UgnineSirdis/ydb-go-sdk/v3/internal/scheme.(*Client).DescribePath"),
		path,
	)
	defer func() {
...
func (c *Client) ModifyPermissions(
	...
	onDone := trace.SchemeOnModifyPermissions(c.config.Trace(), &ctx,
		stack.FunctionID("github.com/UgnineSirdis/ydb-go-sdk/v3/internal/scheme.(*Client).ModifyPermissions"),
		path,
	)
	defer func() {
		onDone(finalErr)
